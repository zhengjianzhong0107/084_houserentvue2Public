  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='jingjiren'" class="input-group">
			   <div class="label">经纪人号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jingjirenhao" class="input" type="text" placeholder="经纪人号">
			   </div>
			 </div> -->
			<el-form-item label="经纪人号" class="input" v-if="tableName=='jingjiren'">
			  <el-input v-model="ruleForm.jingjirenhao" autocomplete="off" placeholder="经纪人号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jingjiren'" class="input-group">
			   <div class="label">经纪人名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jingjirenming" class="input" type="text" placeholder="经纪人名">
			   </div>
			 </div> -->
			<el-form-item label="经纪人名" class="input" v-if="tableName=='jingjiren'">
			  <el-input v-model="ruleForm.jingjirenming" autocomplete="off" placeholder="经纪人名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jingjiren'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='jingjiren'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='jingjiren'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='jingjiren'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jingjiren'" class="input-group">
			...
			<el-form-item label="手机号" class="input" v-if="tableName=='jingjiren'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.jingjirenming) && `jingjiren` == this.tableName){
        this.$message.error(`经纪人名不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `jingjiren` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `jingjiren` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if(`jingjiren` == this.tableName && this.ruleForm.shenfenzheng&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzheng))){
        this.$message.error(`身份证应输入身份证格式`);
        return
      }
      if(`jingjiren` == this.tableName && this.ruleForm.shoujihao&&(!this.$validate.isMobile(this.ruleForm.shoujihao))){
