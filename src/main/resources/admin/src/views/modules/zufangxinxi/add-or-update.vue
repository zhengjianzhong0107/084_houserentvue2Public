<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="租用时长" prop="zuyongshizhang">
          <el-input v-model="ruleForm.zuyongshizhang" 
              placeholder="租用时长" clearable  :readonly="ro.zuyongshizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="租用时长" prop="zuyongshizhang">
              <el-input v-model="ruleForm.zuyongshizhang" 
                placeholder="租用时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="月租金" prop="yuezujin">
          <el-input v-model="ruleForm.yuezujin" 
              placeholder="月租金" clearable  :readonly="ro.yuezujin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="月租金" prop="yuezujin">
              <el-input v-model="ruleForm.yuezujin" 
                placeholder="月租金" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="经纪人号" prop="jingjirenhao">
          <el-input v-model="ruleForm.jingjirenhao" 
              placeholder="经纪人号" clearable  :readonly="ro.jingjirenhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="经纪人号" prop="jingjirenhao">
              <el-input v-model="ruleForm.jingjirenhao" 
                placeholder="经纪人号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="经纪人名" prop="jingjirenming">
          <el-input v-model="ruleForm.jingjirenming" 
              placeholder="经纪人名" clearable  :readonly="ro.jingjirenming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="经纪人名" prop="jingjirenming">
              <el-input v-model="ruleForm.jingjirenming" 
                placeholder="经纪人名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	ispay : false,
      ...
      rules: {
          ...
          zuyongshizhang: [
                { required: true, message: '租用时长不能为空', trigger: 'blur' },
  ...
  computed: {
    ...
    jine:{
      get: function () {
        return 1*this.ruleForm.zuyongshizhang*this.ruleForm.yuezujin
      }
    },
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jine = true;
          ...
          if(o=='jingjirenhao'){
            this.ruleForm.jingjirenhao = obj[o];
	    this.ro.jingjirenhao = true;
            continue;
          }
          if(o=='jingjirenming'){
            this.ruleForm.jingjirenming = obj[o];
	    this.ro.jingjirenming = true;
            continue;
          }
          if(o=='zhanghao'){
